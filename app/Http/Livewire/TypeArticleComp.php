...
class TypeArticleComp extends Component
{
    ...
    public function render()
    {
        ...
        $data = [
            ...
            "proprietesTypeArticles" => ProprieteArticle::where("type_article_id", optional($this->selectedTypeArticle)->id)->paginate(5)
        ];
    ...
    //Annuler l'ajout d'un l'article
    ...
    public function deleteTypeArticle($id){
        ...
        $this->dispatchBrowserEvent("showSuccessMessage", ["message"=>"TypeArticle supprimé avec succès!"]);
    }
    // Affichage et fermeture de l'espace de création de la propriéte d'un type d'article
    ...
    //Ajouter un de la propriété d'un article
    ...
    //Supprimer la propriété d'un article
