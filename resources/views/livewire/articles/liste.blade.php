      ...
      <div class="card">
        <div class="card-header bg-gradient-primary d-flex align-items-center">
          ...
          <div class="card-tools d-flex align-items-center">
            <a class="btn btn-link text-white mr-4 d-block" wire:click="showAddArticleModal"><i class="fas fa-user-plus"></i>Ajouter un nouvel article</a>
        ...
        <div class="card-body table-responsive p-0 table-striped" >
          ...
          <div class="d-flex justify-content-end p-4 bg-indigo" style="height:110 px;">
                  ...
                  @forelse ($articles as $article)
                      <tr>
                        <td>
                          ...
                          <td class="text-center">{{ $article->typeArticle->nom }}</td>
                          ...
                          <td class="text-center">
                            ...
                            <button class="btn btn-link" wire:click="confirmDelete('{{ $article->nom }}', {{$article->id}})"> <i class="far fa-trash-alt"></i> Supprimer</button>                            
                          </td>
                      </tr>
                  @empty
                      <tr>
