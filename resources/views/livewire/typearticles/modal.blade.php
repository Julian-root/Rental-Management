<div class="modal fade" id="modalProp" role="dialog" wire:ignore.self>
    <div class="modal-dialog modal-xl">
  
        <div class="modal-content">
        
            <div class="modal-header">
                <h5 class="modal-title">Gestion des caractéristiques de "{{ optional($selectedTypeArticle)->nom }}" </h5>
            </div>
                ...
                <div class="d-flex my-4 bg-gray-light p-3">
                    <div class="d-flex flex-grow-1 mr-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            @error("newPropModel.estObligatoire") is-invalid @enderror" 
