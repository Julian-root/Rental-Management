...
@include("livewire.typearticles.modal")
      ...
      <div class="card">
        <div class="card-header bg-gradient-primary d-flex align-items-center">
          ...
          <div class="card-tools d-flex align-items-center">
            <a class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddTypeArticleForm"><i class="fas fa-user-plus"></i>Ajouter un nouvel type article</a>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                          <button class="btn btn-link" 
                            wire:click="addNewTypeArticle"> 
                            <i class="fa fa-check"></i> Valider
                          </button>
                          <button class="btn btn-link" 
                            wire:click="toggleShowAddTypeArticleForm"> 
                            <i class="far fa-trash-alt"></i> Annuler
                          </button>
                        </td>
                    </tr>
                  @endif
                  @foreach ($typearticles as $typearticle)
                      <tr>
                          ...
                          <td class="text-center">
                            <button class="btn btn-link" 
                            wire:click="editTypeArticle({{$typearticle->id}})"> 
                            <i class="far fa-edit"></i>  Editer</button>

                            <button class="btn btn-link" 
                            wire:click="showProp({{$typearticle->id}})"> 
                            <i class="fa fa-list"></i>  Propriétés</button>

                            @if(count($typearticle->article)==0)
...
@include("livewire.typearticles.alert")
